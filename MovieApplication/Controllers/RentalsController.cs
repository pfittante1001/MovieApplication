...
namespace MovieApplication.Controllers
{
    ...
    {
        private MoviwMVCEntities db = new MoviwMVCEntities();
        ...
        public ActionResult Create([Bind(Include = "RentalsID,CustomerID,MovieID,Date")] Rental rental)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RentalsID,CustomerID,MovieID,Date")] Rental rental)
        {
            if (ModelState.IsValid)
            {
